-- Recalculate attendance status after cancelling partial/hourly leave.
-- If the employee actually checked in, keep the work log and restore normal on_time/late status.
